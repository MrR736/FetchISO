"""/*
// FetchISO GTK 3.0 for Modern Python
// version 1.0
...
class FetchISOApp(Gtk.Window):
    def __init__(self):
        super().__init__(title="FetchISO - Quickly Fetch ISOs")
        ...
        self.main_vbox.pack_start(self.search_hbox, False, False, 0)
        ...
        self.search_hbox.pack_start(self.arch_selector, True, True, 0)
    ...
    def show_message_dialog(self, message, message_type):
        ...
        content_area.pack_start(ok_button, False, False, 5)
